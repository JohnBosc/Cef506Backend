...
<head>
  ...
  <title>Flight Schedule - Routes</title>
          ...
          <div class="row">
            <div class="col-lg-12" style="color: #FFFFFF;">
              <nav aria-label="breadcrumb" class="bcr">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<c:url value="/route/new"/>"><i class="fa fa-plus">&nbsp;Add</i></a></li>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <c:forEach items="${routes}" var="route">
                                      <tr>
                                        <td>${route.getAirline_iata()}</td>
                                        <td>${route.getSrcAirport_iata()}</td>
                                        <td>${route.getDstAirport_iata()}</td>
                                        <td>${route.getStops()}</td>
                                        <td>

                                          <c:url value="/route/update/${route.getRoute_id()}" var="urlUpdate"/>
                                          <a href="${urlUpdate}"> <i class="fas fa-fw fa-edit"></i></a>&nbsp;
                                          | &nbsp;&nbsp;
                                          <a href="javascript:void(0);" data-toggle="modal" data-target="#modalRoute${route.getRoute_id()}"><i class="fas fa-fw fa-trash" style="color: #CC0000;"></i></a>
                                          <!-- Modal starts here -->

                                          <div class="modal fade" id="modalRoute${route.getRoute_id()}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <c:url value="/route/remove/${route.getRoute_id()}" var="urlRemove"/>
