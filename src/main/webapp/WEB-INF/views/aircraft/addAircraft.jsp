...
<head>
  ...
  <title>Flight Schedule - Add new aircraft</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" align="center">
            ...
            <div class="col-lg-12" style="color: #FFFFFF;">
              <nav aria-label="breadcrumb" class="bcr">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><span style="font-weight: lighter; font-style: italic">Add new aircraft</span></li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="panel-body form-add">
            <f:form action="/aircraft/save" modelAttribute="aircraft" method="post">
              <f:hidden path="aircraft_id"/> <!-- System must not duplicate the entries after update -->

              <div class="form-group">
                <label for="code">IATA Code</label>
                <f:input path="aircraft_code" class="form-control form-fixer" id="code" placeholder="Unique three-letter IATA identifier for the aircraft"/>
              </div>
              <div class="form-group">
                <label for="airline">Airline</label>
                <f:select id="airline" path="airline.airline_id" items="${airlines}" itemLabel="alias" itemValue="airline_id" class="form-control form-control-sm"/>
              </div>

              <div class="panel-footer" style="margin-top: 10px;">
                <a href="<c:url value="/aircraft/"/>" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-fw fa-arrow-left"></i>&nbsp;Cancel</a>
