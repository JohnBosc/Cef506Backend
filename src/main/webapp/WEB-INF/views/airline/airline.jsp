...
<head>
  ...
  <title>Flight Schedule - Airlines</title>
          ...
          <div class="row">
            <div class="col-lg-12" style="color: #FFFFFF;">
              <nav aria-label="breadcrumb" class="bcr">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<c:url value="/airline/new"/>"><i class="fa fa-plus">&nbsp;Add</i></a></li>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <c:forEach items="${airlines}" var="airline">
                                      <tr>
                                        ...
                                        <td>${airline.getAlias()}</td>
                                        <td>${airline.getIata()}</td>
                                        <td>${airline.getIcao()}</td>
                                        <td>${airline.getCallSign()}</td>
                                        <td>${airline.getCountry()}</td>
                                        <td>${airline.getActive()}</td>
                                        <td>
                                          <c:url value="/airline/update/${airline.getAirline_id()}" var="urlUpdate"/>
                                          <a href="${urlUpdate}"> <i class="fas fa-fw fa-edit"></i></a>&nbsp;
                                          | &nbsp;&nbsp;
                                          <a href="javascript:void(0);" data-toggle="modal" data-target="#modalAirline${airline.getAirline_id()}"><i class="fas fa-fw fa-trash" style="color: #CC0000;"></i></a>
                                          <!-- Modal starts here -->

                                          <div class="modal fade" id="modalAirline${airline.getAirline_id()}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <c:url value="/airline/remove/${airline.getAirline_id()}" var="urlRemove"/>
