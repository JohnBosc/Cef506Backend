...
<head>
  ...
  <title>Flight Schedule - Airports</title>
          ...
          <div class="row">
            <div class="col-lg-12" style="color: #FFFFFF;">
              <nav aria-label="breadcrumb" class="bcr">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<c:url value="/airport/new"/>" ><i class="fa fa-plus">&nbsp;Add</i></a></li>
                  <c:url value="/airport/export/" var="export"/>
                  <li class="breadcrumb-item"><a href="${export}"><i class="fa fa-download">&nbsp;Export</i></a></li>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody><%--                                <a href="javascript:void(0);" data-toggle="modal" data-target="#modalAircraft${aircraft.getAirport_id()}"><i class="fas fa-fw fa-trash" style="color: #CC0000;"></i></a>--%>
                  ...
                  <c:forEach items="${airports}" var="airport">
                                      <tr>
                                        ...
                                        <td>${airport.getIata()}</td>
                                        <td>${airport.getIcao()}</td>
                                        <td>GMT ${airport.getTimezone()}</td>
                                        <td>
                                          <c:url value="/airport/update/${airport.getAirport_id()}" var="urlUpdate"/>
                                          <a href="${urlUpdate}"> <i class="fas fa-fw fa-edit"></i></a>&nbsp;
                                          | &nbsp;&nbsp;
                                          <a href="javascript:void(0);" data-toggle="modal" data-target="#modalAirport${airport.getAirport_id()}"><i class="fas fa-fw fa-trash" style="color: #CC0000;"></i></a>
                                          <!-- Modal starts here -->

                                          <div class="modal fade" id="modalAirport${airport.getAirport_id()}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <c:url value="/airport/remove/${airport.getAirport_id()}" var="urlRemove"/>
